describe("a bus", function(){
  ...
  //set bus to be used by all the functions
  ...
  it("accepets a passenger", function(){
    bus.add(passenger);
  ...
  it("won't accept same passenger twice and throws an error", function(){
    bus.add(passenger);
    expect(bus.getSize()).toBe(1);
    var test = function() {
      bus.add(passenger);
  ...
  it("return a list of passengers names", function(){
    bus.add(passenger);
    bus.add(passenger2);
